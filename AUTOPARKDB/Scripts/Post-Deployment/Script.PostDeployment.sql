...
SET IDENTITY_INSERT [dbo].[Путевой лист легкового автомобиля] on
	INSERT INTO [Путевой лист легкового автомобиля] ([ID_Путевого листа],[Номер путевого листа],[За период с],[За период по],[ID_Автомобиль],[ID_Водитель],[ID_Отдела]) 
		VALUES 
		(1,7,N'2014-08-01',N'2014-08-31',1,125,1),
		(2,9,N'2014-09-01',N'2014-09-30',1,4356,1),
...
SET IDENTITY_INSERT [dbo].[Путевой лист Грузового авто] on
	...
	([ID_Путевого листа],[Номер путевого листа],[Дата путевого листа],[ID_Водителя],[ID_Автомобиля],[ID_Отдела],
	...
	VALUES 
		(1,1,N'2014-10-11',125,3,1,281436,282500,N'2014-12-05 8:15AM',N'2014-10-05 10:15AM',N'2014-10-05 8:15AM',N'2014-12-05 11:15AM',123588,123588,0.4,0.5,6,5,100,20,80,80),
		(2,2,N'2014-10-12',4356,4,2,260000,260100,N'2014-12-05 8:15AM',N'2014-10-05 10:15AM',N'2014-10-05 8:15AM',N'2014-12-05 11:15AM',123588,123588,0.4,0.5,6,5,80,10,100,20)
