...
IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Нормы расхода ГСМ на авто,тракторы])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Нормы расхода ГСМ на авто,тракторы] on
...
IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Подвижной состав])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Подвижной состав] on
  ...
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Подвижной состав] OFF
END 

           
IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Личный состав])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Личный состав] on
...
(41256,'Жуковский','765546',2,'2016-02-10')
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Личный состав] OFF
END 

           
IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Путевой лист легкового автомобиля])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Путевой лист легкового автомобиля] on
  ...
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Путевой лист легкового автомобиля] OFF
END 
           
IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Путевой лист Грузового авто])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Путевой лист Грузового авто] on
	INSERT INTO [Путевой лист Грузового авто] ([ID_Путевого листа],[Номер путевого листа],[Дата путевого листа],[ID_Водителя],[ID_Автомобиля],[ID_Работа водителя и авто выезд],[ID_Работа водителя и авто возвращение]) 
		VALUES 
		(20,1,'2014-10-25',125,1,1,1),
		(21,2,'2014-10-26',4356,2,2,2)
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Путевой лист Грузового авто] OFF
END 
           

IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Водители авто])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Водители авто] on
  ...
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Водители авто] OFF
END 
           

IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Задание водителю])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Задание водителю] on
  ...
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Задание водителю] OFF
END 


IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Работа водителя и автомобиля])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Работа водителя и автомобиля] on
  ...
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Работа водителя и автомобиля] OFF
END 

IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Движение ТСМ])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Движение ТСМ] on
	INSERT INTO [Движение ТСМ] ([Остаток ТСМ при выезде],[Остаток ТСМ при возвращении],[ID_Движение ТМЦ],[ID_Путевого листа]) 
		VALUES 
		(25.4,26.2,1,20),
		(36.0,21.8,2,21)
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Движение ТСМ] OFF
END 
 
IF NOT EXISTS (SELECT * FROM [Путевые листы].[dbo].[Заправка ТСМ])
BEGIN
SET IDENTITY_INSERT [Путевые листы].[dbo].[Заправка ТСМ] on
  ...
  SET IDENTITY_INSERT [Путевые листы].[dbo].[Заправка ТСМ] OFF
END 
